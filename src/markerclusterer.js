...
/*--------------------------------
	Kush---my prototype onClick method
*/
/*
...
ClusterIcon.prototype.triggerClusterClick = function() {
 ...
 /* var zoom = this.map_.getZoom();
  //if we have reached the maxZoom and there is more than 1 marker in
  // this cluster, use our onClick method to popup a list of options
